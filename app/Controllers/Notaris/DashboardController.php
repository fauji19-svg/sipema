...
<div class="topbar">
  <div class="topbar-title">Beranda Notaris</div>
...
<div class="mc">
  ...
  <div class="stat-grid">
    <div class="sc gold"><div class="sn"><?= $totalReview ?></div><div class="sl">Menunggu Review</div></div>
    <div class="sc green"><div class="sn"><?= $totalSelesai ?></div><div class="sl">Akta Selesai</div></div>
    <div class="sc"><div class="sn"><?= $totalReview + $totalSelesai ?></div><div class="sl">Total Ditangani</div></div>
  </div>

  <div class="section-card">
    <div class="sh">
      <h6><i class="bi bi-file-earmark-check" style="color:var(--gold);margin-right:6px;"></i>Daftar Akta untuk Direview</h6>
    ...
    <table class="t">
      ...
      <tbody>
        ...
        <tr><td colspan="7" style="text-align:center;padding:28px;color:#999;">
          ...
          Belum ada akta yang perlu direview.
        </td></tr>
        <?php else: ?>
        <?php foreach($permohonan as $i => $p): ?>
        <tr class="<?= $p['status']==='Selesai'?'selesai-row':'' ?>">
          ...
          <td>
            ...
            <span class="bs">● Selesai</span>
            <?php else: ?>
            <span class="brv">● Review Notaris</span>
            <?php endif; ?>
          </td>
          <td style="text-align:center;">
            <div class="aw">
              ...
              <div class="ddbox">
                <a href="/notaris/detail/<?= esc($p['kode_unik']) ?>"><i class="bi bi-eye"></i> Lihat & Review</a>
              </div>
            </div>
          </td>
        </tr>
